...
type ProductCardColors = 'blue' | 'green' | 'gray';

interface ProductCardVariant {
  gradient: string;
}

const productCardVariants: Record<ProductCardColors, ProductCardVariant> = {
  blue: {
    gradient: 'to-[#C8D8FF]',
  },
  green: {
...
@Component({
  ...
  template: `
    <div class="border-box border-hover-box proxy-box">
      ...
      @for (feature of whatsIncluded; track feature) {
        <div class="flex-box-left box-content-txt-sz16 line-h-2 v-top">
      ...
      <button mat-stroked-button class="box-btn blue-btn full-width mt-1d5r"
